...
public class CuentasPorCobrar {
    ...
    public CuentasPorCobrar(int codigoCuentaPorCobrar, String codigoFactura, int anio, int mes, double valorNetoPago, String estadoPago, int codigoAdministracion, int codigoCliente, int codigoLocal) {
